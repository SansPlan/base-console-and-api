...
<template>
  <div
    class="flex items-center flex-shrink-0 pr-2 overflow-hidden transition group"
  ...
  >
    ...
    <span
      v-if="!noClosable"
      class="p-0.5 transition-all cursor-pointer hover:bg-zinc-200 hover:text-red-500 rounded"
